...
namespace TimeExpressParcels\TimeExpressParcels\Ui\Component\MassAction;
    ...
    private function getFilterIds()
    {
        ...
        if ($this->getDataProvider() instanceof \Magento\Ui\DataProvider\AbstractDataProvider) {
            ...
            foreach ($searchResult->getItems() as $item) {
                ...
                $idsArray[] = $item->getData('timeexpress_id');
                // Commenting below code to include orders with no shipment
